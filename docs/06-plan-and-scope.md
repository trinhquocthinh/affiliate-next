...
## 8. Rà soát trước khi lập master plan

Một việc còn treo từ PD §12 và chưa ai làm: **rà lại bảng theo dõi công việc**. Đã phát hiện ít nhất 2 mục ghi là chưa xong nhưng thực tế đã xong (chọn cột trong hàng đợi, và ngưỡng ngày cho việc tự đóng). Nếu còn mục nào tương tự, ước lượng ở §2 đang thừa giờ — và giờ thừa nên chuyển sang P4 chứ không nên để trôi.

Việc này mất chừng 30 phút và nên làm trước phase 9.

...
| E5 | Thẩm quyền | 21 | `[ ]` |
| E6 | Chất lượng dữ liệu & hoàn thiện | 13 | `[ ]` |
| | **Tổng** | **83** | trên quỹ 88 giờ |
...
## 12. Ngoài phạm vi & Kế hoạch tiếp theo
...
- Không tính năng nào trong §12.1 hay §12.3 được thêm vào bảng tiến độ §1 cho tới khi chạm điều kiện hoặc quỹ giờ đợt sau được xác nhận.

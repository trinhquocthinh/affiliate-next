...
Tài liệu này trả lời *xây gì và vì sao*. Nó **không** trả lời *xây thế nào* — phần đó thuộc SDD và tech spec.
...
| F-15 | Nạp báo cáo sàn, ghép tự động, chỉ hiện dòng lệch | E6 | **Must** | *(cần bổ sung BR)* | Đã có tệp mẫu thật; đây là thứ cắt được phần lớn 51 giờ |
...
| F-23 | Gắn mã yêu cầu vào Sub_ID của link affiliate | E6 | **Must** | *(cần bổ sung BR)* | **Hạn 9/9 — không thể bù về sau**, xem §6 |

...
const SPEC_006: Record<Permission, Record<Role, Scope | true | undefined>> = {
  ...
  "request.buyer_note":               { BUYER: "own",     AFFILIATE: undefined, AFFILIATE_MASTER: undefined, ADMIN: "any" },
  "request.order_id.edit_any_status": { BUYER: undefined, AFFILIATE: undefined, AFFILIATE_MASTER: true, ADMIN: true },
  "affiliate.queue.view":             { BUYER: undefined, AFFILIATE: true,  AFFILIATE_MASTER: true,  ADMIN: true },
  "affiliate.claim.unclaimed":        { BUYER: undefined, AFFILIATE: true,  AFFILIATE_MASTER: true,  ADMIN: true },
  "affiliate.claim.override":         { BUYER: undefined, AFFILIATE: undefined, AFFILIATE_MASTER: true, ADMIN: true },
  "affiliate.unclaim":                { BUYER: undefined, AFFILIATE: "own", AFFILIATE_MASTER: "any", ADMIN: "any" },
  ...
  "affiliate.bulk_close":             { BUYER: undefined, AFFILIATE: "own", AFFILIATE_MASTER: "any", ADMIN: "any" },
  "reconciliation.run":               { BUYER: undefined, AFFILIATE: undefined, AFFILIATE_MASTER: true, ADMIN: true },
  "reconciliation.export":            { BUYER: undefined, AFFILIATE: undefined, AFFILIATE_MASTER: true, ADMIN: true },
  "user.manage":                      { BUYER: undefined, AFFILIATE: undefined, AFFILIATE_MASTER: undefined, ADMIN: true },
  "config.manage":                    { BUYER: undefined, AFFILIATE: undefined, AFFILIATE_MASTER: undefined, ADMIN: true },
  "system.bulk_close":                { BUYER: undefined, AFFILIATE: undefined, AFFILIATE_MASTER: undefined, ADMIN: true },
};
